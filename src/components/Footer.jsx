          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-1 mb-8 md:mb-0">
            ...
            <div className="flex flex-col gap-3 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-[13px] text-gray-300 font-medium">eduwayconsultancy@gmail.com</span>
              </div>
            </div>
          ...
          <div className="lg:w-[20%]">
            ...
            <ul className="space-y-4">
              {['Home', 'About Us', 'Testimonial', 'Privacy Policy', 'Terms and Conditions'].map((link) => (
                <li key={link}>
                  <a href={`#${link.split(' ')[0].toLowerCase()}`} className="text-gray-300 hover:text-white transition-colors text-[13px] font-medium flex items-start gap-2">
                    <span className="text-gray-400 font-bold mt-[2px] leading-none">»</span>
            ...
            <p className="text-gray-400 text-[11px] font-medium mt-10">
              &copy; {new Date().getFullYear()} Eduway India<br/>All Rights Reserved
            </p>
          </div>
