...
import aboutBgBottom from '../assets/global.webp';

const About = () => {
  return (
    <section id="about" className="py-10 md:py-12 bg-[#193147] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-[1440px] relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-20 items-center">
          ...
          <div className="w-full lg:w-1/2 relative mt-8 lg:mt-0 flex justify-center lg:justify-end pr-0 lg:pr-8">
            ...
            <div className="relative w-full max-w-[380px] sm:max-w-[440px]">
              ...
              <motion.div
                ...
                className="absolute top-8 -left-2 sm:-left-6 bg-[#A51318] rounded-lg py-2 px-2.5 sm:py-2.5 sm:px-3 flex items-center gap-2 sm:gap-2.5  z-20 max-w-[90%]"
              >
                <div className="w-7 h-7 sm:w-8 sm:h-8 bg-white rounded-full flex items-center justify-center text-[#A51318] shrink-0">
              ...
              >
                ...
                <div className="absolute -top-3 -left-3 sm:-top-3.5 sm:-left-3.5 w-7 h-7 sm:w-8 sm:h-8 bg-[#A51318] rounded-full flex items-center justify-center text-white  z-30">
                ...
                <div className="py-2.5 flex flex-col items-center">
                  ...
                  <div className="relative w-20 h-10 flex justify-center">
                    <div className="absolute top-0 w-20 h-10 overflow-hidden">
                      <div className="w-20 h-20 rounded-full border-[4px] border-[#A51318] border-b-transparent border-r-transparent rotate-45"></div>
                    </div>
                ...
                <div className="pt-1 flex items-center justify-center gap-1">
                  <div className="flex -space-x-1.5">
                    <img src="https://flagcdn.com/w40/ru.webp" alt="Russia" className="w-3.5 h-3.5 rounded-full border border-white object-cover " />
                    <img src="https://flagcdn.com/w40/kz.webp" alt="Kazakhstan" className="w-3.5 h-3.5 rounded-full border border-white object-cover " />
                    <div className="w-3.5 h-3.5 rounded-full bg-red-50 border border-white flex items-center justify-center text-[6px] font-bold text-[#A51318]">+</div>
                  </div>
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-start lg:pl-10 mt-12 lg:mt-0 relative z-20">
            ...
            >
              <Send size={14} className="text-[#A51318]" strokeWidth={2.5} />
            ...
            >
              <div className="w-10 h-[2px] bg-[#A51318]"></div>
              <div className="w-1 h-[2px] bg-[#A51318]"></div>
              <div className="w-1 h-[2px] bg-[#A51318]"></div>
            </motion.div>
            ...
            <motion.a 
              ...
              className="inline-block mt-2 px-7 py-2.5 bg-[#A51318] text-white rounded-full font-bold text-[13px]  hover:-translate-y-1 transition-all duration-300 uppercase tracking-wide"
            >
              Get Started
            </motion.a>
