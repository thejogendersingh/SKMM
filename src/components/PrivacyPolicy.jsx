  ...
  return (
    <div className="pt-24 pb-16 bg-white min-h-screen">
      <div className="container mx-auto px-4 md:px-8 max-w-4xl">
        <h1 className="text-3xl md:text-4xl font-bold text-[#121935] mb-8 border-b pb-4">Privacy Policy</h1>
        
        <div className="prose prose-slate max-w-none text-gray-700 space-y-6">
          <p>
            At SKMM Consultancy, your privacy is our priority. This Privacy Policy outlines how we collect, use, and protect the personal information of our students, parents, and website visitors seeking guidance for MBBS admissions abroad.
          </p>

          <h2 className="text-xl font-bold text-[#121935] mt-8 mb-4">1. Information We Collect</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#121935] mt-8 mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-xl font-bold text-[#121935] mt-8 mb-4">3. Data Sharing and Third Parties</h2>
          <p>
            SKMM Consultancy does not sell, rent, or trade your personal information. We only share necessary details with authorized entities involved in your admission process:
          </p>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-xl font-bold text-[#121935] mt-8 mb-4">4. Data Security</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#121935] mt-8 mb-4">5. Cookies and Tracking</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#121935] mt-8 mb-4">6. Your Rights</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#121935] mt-8 mb-4">7. Changes to This Policy</h2>
          <p>
            SKMM Consultancy reserves the right to update this Privacy Policy periodically. Any changes will be posted on this page with an updated effective date. We encourage you to review this policy regularly.
          </p>

          <h2 className="text-xl font-bold text-[#121935] mt-8 mb-4">8. Contact Us</h2>
          <p>
