  ...
  return (
    <div className="pt-24 pb-16 bg-white min-h-screen">
      <div className="container mx-auto px-4 md:px-8 max-w-4xl">
        <h1 className="text-3xl md:text-4xl font-bold text-[#193147] mb-8 border-b pb-4">Privacy Policy</h1>
        ...
        <div className="prose prose-slate max-w-none text-gray-700 space-y-6">
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">1. Information We Collect</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">3. Data Sharing and Third Parties</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">4. Data Security</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">5. Cookies and Tracking</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">6. Your Rights</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">7. Changes to This Policy</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">8. Contact Us</h2>
          <p>
