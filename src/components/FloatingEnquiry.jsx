    ...
    <>
      ...
      >
        ...
        <div className="bg-white w-[300px]  rounded-tl-2xl rounded-bl-2xl border-l border-b border-t border-gray-200 overflow-hidden relative">
          ...
          {/* Header */}
          <div className="bg-[#193147] p-5 text-white relative flex items-center gap-3">
    ...
    setIsOpen(false);
            ...
            <div>
              <input 
                ...
                required
                className="w-full bg-gray-50 border border-gray-200 text-gray-800 text-[14px] rounded-lg px-4 py-2.5 focus:outline-none focus:border-[#A51318] focus:bg-white transition-all"
              />
            </div>
            <div>
              <input 
            ...
            <div>
              <select name="destination" className="w-full bg-gray-50 border border-gray-200 text-gray-800 text-[14px] rounded-lg px-4 py-2.5 focus:outline-none focus:border-[#A51318] focus:bg-white transition-all cursor-pointer">
            ...
            <button 
              type="submit"
              className="w-full bg-[#A51318] text-white rounded-lg py-3 font-bold text-[14px] flex items-center justify-center gap-2 hover:from-[#B00010] hover:to-[#2563EB] transition-colors  #A51318]/30 mt-2"
            >
              Submit <Send size={16} />
            </button>
          </form>
        ...
        <button
          ...
          className={`absolute top-20 -left-[40px] w-[40px] h-[120px] bg-[#193147] rounded-l-lg  flex items-center justify-center transition-opacity duration-300 ${isOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
        >
          <span 
