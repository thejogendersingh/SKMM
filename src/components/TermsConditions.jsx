  ...
  return (
    <div className="pt-24 pb-16 bg-white min-h-screen">
      <div className="container mx-auto px-4 md:px-8 max-w-4xl">
        <h1 className="text-3xl md:text-4xl font-bold text-[#193147] mb-8 border-b pb-4">Terms and Conditions</h1>
        ...
        <div className="prose prose-slate max-w-none text-gray-700 space-y-6">
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">1. Scope of Services</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">2. User Responsibilities</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">3. Fees and Payments</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">4. Admission and Visa Decisions</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">5. Travel and Accommodation</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">6. Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">7. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">8. Governing Law and Jurisdiction</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#193147] mt-8 mb-4">9. Amendments</h2>
          <p>
